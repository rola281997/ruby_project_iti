...
ActiveRecord::Schema.define(version: 2020_05_07_145546) do
...
ActiveRecord::Schema.define(version: 2020_05_07_080224) do
  ...
  create_table "checkouts", force: :cascade do |t|
    ...
    t.index ["seller_id"], name: "index_checkouts_on_seller_id"
  end
  ...
  add_foreign_key "checkouts", "users", column: "seller_id"
